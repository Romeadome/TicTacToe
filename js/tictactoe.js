...
function placeXOrO(squareNumber) {
    ...
    //see if it contains th square number clicked on.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    //this line accesses or html canvas element
    const canvas = document.getElementById('win-lines');
    //this line gives us access to methods and properties to use oncanvas
...
//this line disallows click while the win sound is playing
disableClick();
